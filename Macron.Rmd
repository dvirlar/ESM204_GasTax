...
**To:** President Macron <br>
**From:** Daphne Virlar and Laura Ingulsrud, Ceci N'est Pas Une Pipe Consulting LLC <br>
**Re:** Economic, environmental, and distributional effects of a gas tax proposal in France <br>
**Date:** 1 May 2019<br>
...
kable(all_table, booktabs = T, col.names = c("Tax Amount", "Low Income Consumer Welfare", "High Income Consumer Welfare", "Producer Welfare" )) %>%
  ...
  kable_styling(c("striped", "bordered", "hold_position"), full_width = F) %>% 
  add_header_above(c("USD/Gallon" = 1, "Millions USD" = 3))
```
...
####**6.** 
The invention of electric cars has a bigger impact on environmental quality as it reduces the environmental cost by $220,107.70 more than a $2/gal gas tax does. With a $2/gal gas tax, the environmental cost is $487,283.90. With the invention of electric cars, the environmental cost is $267,176.20.