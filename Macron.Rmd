...
```{r, echo=FALSE}
kable(all_table, booktabs = T, col.names = c("Tax Amount (USD)", "Low Income Consumer Welfare (Million USD)", "High Income Consumer Welfare (Million USD)", "Producer Welfare (Million USD" )) %>%
  kable_styling(latex_options = c("striped", "bordered", "hold_position"))
```
